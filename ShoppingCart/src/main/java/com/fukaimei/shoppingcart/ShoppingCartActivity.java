...
public class ShoppingCartActivity extends Activity implements OnClickListener {
    ...
    private String[] mNameArray = {
            "小米MIX 2", "Mate8", "Android进阶之光", "第一行代码Android 第2版", "第一行代码Java(视频讲解版)", "第一季Kotlin崛起：次世代Android开发"
    };
    private String[] mDescArray = {
            "小米MIX 2 6GB+64GB版 全面屏2.0 骁龙835旗舰处理器",
            "华为 HUAWEI Mate8 3GB+32GB版 移动联通4G手机（月光银）",
            "Android进阶之光 刘望舒 电子工业出版 Android工程师进阶特性网络事件总线注入应用书籍",
            "第一行代码Android 第2版 郭霖 第二版 人民邮电出版社 手机移动安卓android 7.0 Studio系统编程开发APP应用入门到精通基础教程书籍",
            "第一行代码Java(视频讲解版) 李兴华 人民邮电出版社 Java语言编程设计教程疯狂讲义 Java编程思想核心技术 Java从入门到精通零基础自学",
            "第一季Kotlin崛起：次世代Android开发 Kotlin实战 详解Kotlin的面向对象 Kotlin开发框架 Kotlin教程 移动开发教材书籍"
    };
    private double[] mPriceArray = {3299.00, 2499.00, 79.00, 79.00, 89.00, 99.00};
    private int[] mThumbArray = {
            R.drawable.xiaomi_s, R.drawable.huawei_s, R.drawable.android01_s,
            R.drawable.android02_s, R.drawable.android03_s, R.drawable.android04_s
};
    private int[] mPicArray = {
            R.drawable.xiaomi, R.drawable.huawei, R.drawable.android01,
            R.drawable.android02, R.drawable.android03, R.drawable.android04
    };
